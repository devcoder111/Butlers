...
import NearestStoresRegist from './NearestStores'
...
class NearestStoresContainer extends Component {
	...
	render() {
		...
		return <NearestStoresRegist navigation={navigation} locations={locations} />
	}
}
...
export default connect(mapStateToProps, mapDispatchToProps)(NearestStoresContainer)
